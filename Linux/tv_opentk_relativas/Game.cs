...
protected override void OnRenderFrame(FrameEventArgs e) //
{
    ...
    // Dibuja el primer televisor en la posición superior derecha
    //fig.setBasePosition(0.7f, 0.7f, 0.0f);
    //fig.dibujarTv();

    // Dibuja el segundo televisor en la posición inferior derecha
    fig.setBasePosition(0.7f, -0.7f, 0.0f);
    fig.dibujarTv();

    // Dibuja el tercer televisor en la posición superior izquierda
    fig.setBasePosition(-0.7f, 0.7f, 0.0f);
    fig.dibujarTv();

    // Dibuja el cuarto televisor en la posición inferior izquierda
    fig.setBasePosition(-0.7f, -0.7f, 0.0f);
    fig.dibujarTv();
